...
import { AppBar, Toolbar, Typography, Button, Container, Card, CardContent, CardActions, Grid, Stack , Divider} from '@mui/material';
...
function MuiSamplePage() {
  return (
    ...
    <Container maxWidth="sm" >Question</Container>
